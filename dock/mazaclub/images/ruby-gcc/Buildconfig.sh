...
# build config
#
PACKAGES="=app-eselect/eselect-ruby-20151229  dev-lang/ruby dev-util/pkgconfig"
KEEP_HEADERS=true
...
configure_bob()
{
    ...
    #cp /config/ruby-2.3.0.ebuild /usr/portage/dev-lang/ruby
    ...
    emerge -v =app-eselect/eselect-ruby-20151229 =dev-lang/ruby-2.3.0
    #ebuild /usr/portage/dev-lang/ruby/ruby-2.3.0.ebuild manifest
}
