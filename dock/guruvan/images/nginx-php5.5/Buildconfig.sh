...
finish_rootfs_build()
{
    # set php iconv default to UTF-8, if you need full iconv functionality set ICONV_FROM=guruvan/glibc above
    ...
    wget -O $EMERGE_ROOT/var/www/adminer/adminer.php https://www.adminer.org/static/download/4.2.3/adminer-4.2.3-en.php
